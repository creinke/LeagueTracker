    ...
    <Stack.Navigator>
      {user ? (
        <>
          ...
          <Stack.Screen name="SeasonDetail" component={SeasonDetailScreen} options={{ title: 'Season Detail' }} />
          ...
          <Stack.Screen name="Substitution" component={SubstitutionScreen} options={{ title: 'Substitute Players' }} />
        </>
      ) : (
