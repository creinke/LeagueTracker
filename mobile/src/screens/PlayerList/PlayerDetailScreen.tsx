  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.section}>
        ...
        <Text style={styles.value}>{player.firstname} {player.middlenameOrInitial} {player.lastname} {player.generation}</Text>
      </View>
      <View style={styles.section}>
      ...
      {player.address && (
        <View style={styles.section}>
          ...
          <Text style={styles.value}>{player.address.city}, {player.address.region} {player.address.postalCode}</Text>
        </View>
      )}
    </ScrollView>
  );
