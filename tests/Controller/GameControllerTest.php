...
class GameControllerTest extends WebTestCase {
	...
	public function testRouteNames(): void {
		...
		$this->assertEquals('/game/view/1/2/3', $router->generate('game_view', ['event_id' => 1, 'game_id' => 2, 'gamenumber' => 3]));
		$this->assertEquals('/game/new/1', $router->generate('game_new', ['event_id' => 1]));
		$this->assertEquals('/game/edit/1/2/3', $router->generate('game_edit', ['event_id' => 1, 'game_id' => 2, 'gamenumber' => 3]));
		$this->assertEquals('/game/delete/1/2', $router->generate('game_delete', ['event_id' => 1, 'game_id' => 2]));
		$this->assertEquals('/game/post/scores/1/2/3', $router->generate('post_scores', ['event_id' => 1, 'game_id' => 2, 'gamenumber' => 3]));
		$this->assertEquals('/game/change/players/1/2/3', $router->generate('game_change_players', ['event_id' => 1, 'game_id' => 2, 'gamenumber' => 3]));
