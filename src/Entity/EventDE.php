...
#[ORM\Index( name: "fk_event_course_id", columns: ["course_id"])]
#[ORM\Index( name: "fk_event_nine_id", columns: ["nine_id"])]
#[ORM\Index( name: "fk_event_secondnine_id", columns: ["secondnine_id"])]
#[ORM\Index( name: "fk_event_tee_id", columns: ["tee_id"])]
#[ORM\Index( name: "fk_event_session_id", columns: ["session_id"])]
class EventDE {
    #[ORM\Id]
    ...
    private ?int $format;
    #[ORM\OneToMany( targetEntity: "App\Entity\GameDE", mappedBy: "event", cascade: ["all"], fetch: "EAGER", orphanRemoval: true)]
    ...
    #[ORM\OneToMany( targetEntity: "App\Entity\TeamgameDE", mappedBy: "event", cascade: ["all"], fetch: "EAGER", orphanRemoval: true)]
    #[ORM\OrderBy(["startingtime" => "ASC"])]
    ...
    public function setRegistrants(Collection $registrants): void {
    ...
    public function setTeamgames(Collection $teamgames): void {
