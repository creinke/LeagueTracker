...
class GameScoresFormBean {
    ...
    /**
     * @return ArrayCollection number of nines played
     */
    public function getNinesPlayed(): ArrayCollection {
     ...
     */
    public function getPlayerScores(): ArrayCollection {
     ...
     * @return TeeDE|null
     */
    private function getTee(NineDE $nine, string $teeName) : ?TeeDE {
    ...
    private function initializePlayerScores(?PlayermatchDE $playerMatch, PlayerDE $player, ?array $teamPlayingPartners, ?ArrayCollection $scores, ArrayCollection $ninesPlayed, string $teeName): void {
    ...
    /**
     * @param ArrayCollection $ninesPlayed
     *
     * @return void
     */
    public function setNinesPlayed(ArrayCollection $ninesPlayed) : void {
        $this->ninesPlayed = $ninesPlayed;
    }
}